...
- [Discord.JS-Selfbot-V13](https://github.com/aiko-chan-ai/discord.js-selfbot-v13) (seems to be a smaller modification to discord.js, plus, it sends intents which is pretty problematic. not the best, but it's in nodejs and seems to work pretty well) (example [here](https://github.com/aiko-chan-ai/discord.js-selfbot-v13#example))
